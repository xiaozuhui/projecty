...
<style>
  h2,h3,p{margin:0}.section-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:16px;margin-bottom:16px}.section-heading h2{font-size:18px}.section-heading p{margin-top:5px;color:var(--color-text-muted);font-size:13px}.count-label{color:var(--color-text-muted);font-size:13px}.project-list{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px}.project-card{display:grid;gap:10px;min-width:0;padding:17px;border:1px solid var(--color-border);border-radius:var(--radius-md);transition:transform .18s ease,box-shadow .18s ease,border-color .18s ease}.project-card:hover{border-color:#b9c9f8;box-shadow:var(--shadow-md);transform:translateY(-2px)}.project-card-top{display:flex;align-items:center;justify-content:space-between;gap:8px}.project-card-top strong{color:var(--color-primary-strong);font-family:var(--font-mono);font-size:13px}.project-card h3{font-size:18px}.project-card p{min-height:42px;color:var(--color-text-muted);font-size:13px;line-height:1.6}.project-meta{display:flex;justify-content:space-between;gap:8px;padding-top:10px;border-top:1px solid var(--color-border);color:var(--color-text-muted);font-size:12px}.archived-label{padding:3px 8px;border-radius:999px;color:var(--color-warning);background:#fff6e8;font-size:12px}.state-box{display:grid;place-items:center;gap:8px;min-height:180px;color:var(--color-text-muted);text-align:center}.state-box p{font-size:13px}.error-state{color:var(--color-danger)}.pager{display:flex;justify-content:flex-end;gap:8px;margin-top:18px}.secondary-button:disabled{cursor:not-allowed;opacity:.45}@media(max-width:1100px){.project-list{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:640px){.project-list{grid-template-columns:1fr}.section-heading{display:block}.count-label{display:block;margin-top:8px}.project-meta{display:grid}}
</style>
