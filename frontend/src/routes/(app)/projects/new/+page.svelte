...
<style>
  .project-form{display:grid;gap:16px;max-width:760px}.form-intro{display:grid;gap:4px;padding-bottom:5px;border-bottom:1px solid var(--color-border)}.form-intro span{color:var(--color-text-muted);font-size:13px}label{display:grid;gap:7px;font-weight:700}input,select,textarea{width:100%;border:1px solid var(--color-border);border-radius:10px;padding:11px 12px;color:var(--color-text);background:var(--color-surface);resize:vertical}input:focus,select:focus,textarea:focus{outline:3px solid var(--color-primary-soft);border-color:var(--color-primary)}.form-error{margin:0;color:var(--color-danger);font-size:14px}.form-actions{display:flex;justify-content:flex-end;gap:10px;padding-top:4px}.form-actions button{border:0}.form-actions a{min-width:72px}
</style>
