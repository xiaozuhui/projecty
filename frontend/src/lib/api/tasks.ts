...
export function updateTask(taskKey: string, input: { title?: string; description?: string | null; priority?: string; task_type?: string; assignee_id?: string | null; reviewer_id?: string | null; start_at?: string | null; due_at?: string | null; parent_task_id?: string | null; milestone_id?: string | null }) { return apiPatch<TaskView>(`/tasks/${key(taskKey)}`, input); }
