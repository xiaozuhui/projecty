...
export function createTask(projectKey: string, input: { title: string; description?: string; priority?: string; status_id?: string; assignee_id?: string | null; reviewer_id?: string | null; due_at?: string | null }) { return apiPost<TaskView>(`/projects/${key(projectKey)}/tasks`, input); }
export function createSubtask(taskKey: string, input: { title: string; description?: string; priority?: string; status_id?: string; assignee_id?: string | null; reviewer_id?: string | null; due_at?: string | null }) { return apiPost<TaskView>(`/tasks/${key(taskKey)}/subtasks`, input); }
export function updateTask(taskKey: string, input: { title?: string; description?: string; priority?: string; assignee_id?: string | null; reviewer_id?: string | null; due_at?: string | null; parent_task_id?: string | null }) { return apiPatch<TaskView>(`/tasks/${key(taskKey)}`, input); }
