...
export type TaskView = { id: string; task_key: string; project_id: string; parent_task_id: string | null; task_number: number; title: string; description: string | null; priority: Priority; task_type: TaskType; status_id: string; position: number; assignee_id: string | null; assignee_name: string | null; reviewer_id: string | null; reviewer_name: string | null; reporter_id: string; start_at: string | null; due_at: string | null; milestone_id: string | null; labels: LabelView[]; created_at: string; updated_at: string };
