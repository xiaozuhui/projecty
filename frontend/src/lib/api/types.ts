...
export type TaskView = { id: string; task_key: string; project_id: string; parent_task_id: string | null; task_number: number; title: string; description: string | null; priority: Priority; status_id: string; position: number; assignee_id: string | null; reporter_id: string; due_at: string | null; created_at: string; updated_at: string };
