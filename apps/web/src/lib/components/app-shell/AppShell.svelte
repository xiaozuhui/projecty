...
<div class="app-shell">
  <aside class="sidebar">
    ...
    <div class="sidebar-footer"><a class="user-card" href="/settings/profile"><span class="avatar">许</span><span class="user-info"><strong>系统管理员</strong><small>super_admin</small></span></a></div>
  </aside>
...
<style>
  ...
  .sidebar-footer{margin-top:auto;padding-top:16px;border-top:1px solid #f0f2f6}.user-card{display:flex;align-items:center;gap:12px;padding:8px;border-radius:12px}.user-card:hover{background:#f0f3fa}.avatar{width:38px;height:38px;border-radius:50%;font-weight:700}.user-info{display:grid}.user-info small{color:var(--color-text-muted)}
  ...
  @media(max-width:1024px){.sidebar{flex-basis:82px;padding-inline:12px}.logo span:last-child,.nav-item span:last-child,.nav-section,.user-info{display:none}.logo,.nav-item{justify-content:center}}
